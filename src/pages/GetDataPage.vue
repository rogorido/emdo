<template>
  ...
  <h4>Accesibilidad de los datos</h4>
  ...
  <p>
    ...
    infraestructura informática de esta página sean conscientes de las licencias
    bajo las que están liberados tantos los datos como el código informático.
    Excepto cuando se diga lo contrario, usaremos estas licencias:
  </p>
