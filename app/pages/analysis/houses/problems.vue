<template>
  <div>
    <h4>Problemas y dificultades</h4>
    <p>
      Los datos recopilados están inevitablemente cargados de problemas de
      diversa índole, entre los que podemos destacar los siguientes:
    </p>
    <ul>
      <li>
        ...
        aceptadas por el capítulo general (dato este más preciso). (3) Una
        fundación podía además no resistir el paso del tiempo y aunque su
        supresión no era tarea fácil, podían acabar decayendo.
      </li>
      <li>
        ...
        contingentes a los nuevos territorios ultramarinos, etc.
      </li>
      ...
      <li>
        ...
        rango de una determinada localidad
      </li>
      <li>
